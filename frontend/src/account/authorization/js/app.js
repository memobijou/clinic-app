...
import '~/account/authorization/css/main.css'
...
$(document).ready(function(){
	var dt = $('#datatable-default').DataTable( {
      ...
      columnDefs: [
        ...
        {targets: 1, title: "Email", name: "email"},
      ],
    ...
    let options = [
        //["activation", "Benutzer aktivieren"], ["deactivation", "Benutzer deaktivieren"],
        ["deletion", "Einträge löschen"]
    ]
