...
class AccomplishmentViewSet(viewsets.ModelViewSet):
    queryset = UserAccomplishment.objects.prefetch_related(
        "accomplishment__users").select_related("accomplishment").all()
    ...
    def get_queryset(self):
        ...
        self.queryset = self.queryset.filter(user__pk=user_id, accomplishment__pk=accomplishment_id).exclude(
